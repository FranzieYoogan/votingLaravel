...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('/css/biologist.css')}}">
    ...
    <body class="antialiased">
        ...
        @if(isset($contestants))
                    ...
                    <div >
                        ...
                        <form method="POST" action="/biologist" style="display: flex; gap:1em; margin-bottom: 1em">
                            @csrf
